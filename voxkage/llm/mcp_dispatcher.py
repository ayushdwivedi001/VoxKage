...
TOOL_TO_SERVER = {
    ...
    "spawn_task": "task_server.py",
    "complete_task": "task_server.py",
    "check_tasks": "task_server.py",
    "get_task_result": "task_server.py",
    "log_step": "task_server.py",
    "clear_task": "task_server.py",
    "clear_completed_tasks": "task_server.py",
    "cancel_task": "task_server.py",
    "cancel_all_tasks": "task_server.py",
    "clear_all_tasks": "task_server.py",
    "restore_checkpoint": "task_server.py",
    "spawn_evolution_task": "task_server.py",
